...
<body>
    ...
    <main class="table" id="customers_table">
        <section class="table__header">
            ...
            <div class="Upload">
                <form action="http://localhost/qlhs/Taikhoan/upload" method="post" enctype="multipart/form-data">
...
if ($row['Quyen'] == 'Nhân viên') {
    ...
    echo '<form action="http://localhost/qlhs/DSTaikhoan/sua/' . $row['Id'] . '" method="post">';
    echo '<button class="button-85" role="button">Sửa</button>  ';
    echo '</form>';

    // Hiển thị nút Xóa
    echo '<form action="http://localhost/qlhs/DSTaikhoan/xoa/' . $row['Id'] . '" method="post">';
